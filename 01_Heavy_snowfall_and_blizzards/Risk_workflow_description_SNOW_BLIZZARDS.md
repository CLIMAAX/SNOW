...
## Hazard assessment: impact-based indicators
...
- [ERA5 single-level dataset](https://cds.climate.copernicus.eu/datasets/reanalysis-era5-single-levels?tab=overview)
- [CORDEX single-level dataset](https://cds.climate.copernicus.eu/datasets/projections-cordex-domains-single-levels?tab=overview)
...
1. [Hazard assessment for heavy snowfall and blizzards](./Hazard_assessment_SNOW_BLIZZARDS.ipynb)
2. [Risk assessment using hazard impact indicators and population exposure data](./Risk_assessment_SNOW_BLIZZARDS.ipynb)
...
- Vajda A., H. Tuomenvirta, I. Juga, P. Nurmi, P. Jokinen, J. Rauhala, 2014: Severe weather affecting European transport systems: the identification, classification and frequencies of events. Nat. Hazards, 72 (2014), pp. 169-188, DOI: [10.1007/s11069-013-0895-4](https://doi.org/10.1007/s11069-013-0895-4)
